...
class TestTextProcessor:
    ...
    def test_process_text_with_regex(self, mock_config):
        ...
        mock_config.regex_pattern = re.compile(r'\b\w+@\w+\.\w+\b')  # Simple email pattern
    ...
    def test_process_text_with_ner(self, mock_time, mock_config):
        ...
        mock_ner_model = Mock()
        mock_ner_model.predict_entities = Mock(return_value=[
            {"text": "John Doe", "label": "person", "score": 0.9}
        ])

...
from core.engines import EngineRegistry, DetectionResult
...
class TestRegexEngine:
    ...
    def test_regex_engine_validation(self):
        ...
        mock_match.groups.return_value = (None, None, None, None, None, None, None, None, None, None, None, "4111111111111111")
        ...
        with patch('core.engines.regex_engine.config_regex_sorted', {11: config_entry}):
            with patch('core.engines.regex_engine.CreditCardValidator') as mock_validator:
                mock_validator.validate.return_value = (True, "visa")
                
                engine = RegexEngine(mock_config)
                results = engine.detect("4111111111111111")

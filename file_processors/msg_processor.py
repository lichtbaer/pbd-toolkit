    ...
    def extract_text(self, file_path: str) -> str:
        ...
        try:
            ...
            headers_to_extract = [
                ...
                'returnPath', 'sender', 'receivedRepresentingName',
                'displayTo', 'displayCc', 'displayBcc'
            ]
            ...
            email_properties = [
                'senderEmail', 'senderEmailAddress', 'senderName',
                'receivedRepresentingEmail', 'receivedRepresentingEmailAddress',
                'sentRepresentingEmail', 'sentRepresentingEmailAddress'
            ]
